...
SELECT customer_id, profile:first_name, profile:address:city
FROM customers
...
SELECT schema_of_json('{"first_name":"Averil","last_name":"Blunsum","gender":"Male","address":{"street":"519 Caliangt Point","city":"Talisayan","country":"Philippines"}}') from customers
