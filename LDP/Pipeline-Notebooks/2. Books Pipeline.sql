...
AS SELECT * FROM cloud_files("/Volumes/workspace/default/data/bookstore/books-cdc", "json")
...
CREATE MATERIALIZED VIEW author_counts
...
CREATE TEMPORARY VIEW books_sales
AS 
